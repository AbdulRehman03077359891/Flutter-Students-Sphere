...
class NotificationServices {
    ...
    FirebaseFirestore.instance
      ...
      for (var change in snapshot.docChanges) {
        if (change.type == DocumentChangeType.added) {
          ...
          String userName = change.doc.data()?['studentName'];
          showLocalNotification(
              "New Request", "New Request from: $userName");
        }
      }
    });
  }
  ...
  Future<void> showLocalNotification(String title, String body) async {
    const AndroidNotificationChannel channel = AndroidNotificationChannel(
      ...
      'New Requests', // title
      description: 'Channel for new requests notifications',
      importance: Importance.max,
      enableLights: true,
...
// Create the notification channel on Android if it's not already created
    ...
    AndroidNotificationDetails androidNotificationDetails =
      ...
      channelDescription: 'Channel for new requests notifications',
      importance: Importance.max,
      priority: Priority.high,
      ticker: 'ticker',
