...
import 'package:studentsphere/Screens/Firebase/sign_up.dart';
            ...
            child: Form(
              ...
              child: SingleChildScrollView(
                child: Column(
                  ...
                  children: [SizedBox(height: MediaQuery.of(context).size.height*.3,child: Image.asset('assets/images/studentsphere-logo.png')),
                    const Text(
                    ...
                    Row(
                      ...
                      children: [
                        TextButton(
                            ...
                            child: const Text(
                              "Forgot password?",
                              style: TextStyle(color: Color.fromARGB(255, 18, 40, 136)),
                            ))
                      ],
                    ),
                    const SizedBox(
                    ...
                    fireController.isLoading.value
                        ? const CircularProgressIndicator(color: Color.fromARGB(255, 18, 40, 136),)
                        : ElevatedButton(
                    ...
                    RichText(
                      ...
                      children: [
                        ...
                        TextSpan(
                            text: "Register",
                            style: const TextStyle(color: Color.fromARGB(255, 18, 40, 136),fontWeight: FontWeight.w500),
                            recognizer: TapGestureRecognizer()
                              ..onTap = () {
                                Get.to(const SignUpPage(userType: 'Student',));
                              })
                      ],
                    )),
                  ],
